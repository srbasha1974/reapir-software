...
3. `cd training/recorder && npx tsx 02-inward.ts` writes `out/02-inward.webm`.
4. Encode: `ffmpeg -ss 1.3 -i out/02-inward.webm -c:v libx264 -crf 24 -pix_fmt yuv420p -movflags +faststart -an ../media/02-receiving-a-delivery.mp4`
