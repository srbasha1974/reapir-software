...
export const CAPTIONS = {
  en: {
    ...
    labour: 'Labour charge = normal price less parts.<small>Worked out for you. Never typed.</small>',
  ...
  ta: {
    ...
    labour: '“Labour charge” = நார்மல் ப்ரைஸ் மைனஸ் பார்ட்ஸ்.<small>சிஸ்டமே கணக்கு போடும். டைப் பண்ண வேண்டாம்.</small>',
