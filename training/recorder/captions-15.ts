...
export const CAPTIONS = {
  en: {
    ...
    byHand: 'No rate card? You type it. It is marked “set by hand”.<small>Type what a regular customer pays on a normal day.</small>',
    premium: 'Price above normal → “Premium”. Say why.<small>The reason is required: here, Urgent turnaround.</small>',
    labourLive: '“Labour charge”: the normal price, less parts.<small>Parts billed come off it as they are booked.</small>',
    ...
    marginCard: {
      ...
      rows: [
        ...
        ['Rework rolled up', '− ₹0', 'a comeback’s cost lands here (next clip, Money 2)'],
        ['= Labour margin', '₹5,200', ''],
      ],
  ...
  ta: {
    ...
    byHand: 'ரேட் கார்டு இல்லையா? நீங்களே டைப் பண்ணுங்க. “set by hand”னு மார்க் வரும்.<small>ரெகுலர் கஸ்டமர் சாதாரண நாள்ல கொடுக்கற ப்ரைஸை போடுங்க.</small>',
    premium: 'நார்மலுக்கு மேல ப்ரைஸ் → “Premium”. காரணம் சொல்லணும்.<small>காரணம் கட்டாயம்: இங்க Urgent turnaround.</small>',
    labourLive: '“Labour charge”: நார்மல் ப்ரைஸ், பார்ட்ஸ் கழிச்சு.<small>பார்ட்ஸ் புக் ஆகும்போது Parts billed இதுல இருந்து கழியும்.</small>',
    ...
    marginCard: {
      ...
      rows: [
        ...
        ['Rework rolled up', '− ₹0', 'திரும்ப வந்த ஜாப் காஸ்ட் இங்க வரும் (அடுத்த கிளிப், மணி 2)'],
        ['= Labour margin', '₹5,200', ''],
      ],
