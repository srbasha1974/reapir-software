...
export const CAPTIONS = {
  en: {
    ...
    trialOwner: 'Now the Sales Head. A Trial account is theirs.<small>It became Trial by itself when its first job was booked in.</small>',
  ...
  ta: {
    ...
    typo: 'நபரின் பக்கம்: பெயரிலோ பதவியிலோ பிழையா? இங்கே சரிசெய்யவும்.<small>Save corrections. ஒவ்வொரு மாற்றமும் பதிவாகும்.</small>',
    ...
    trialOwner: 'இப்போது Sales Head. Trial கணக்கு அவருடைய பொறுப்பு.<small>முதல் job பதிவானதும் அது தானாகவே Trial ஆனது.</small>',
