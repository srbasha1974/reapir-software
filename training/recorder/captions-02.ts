...
export const CAPTIONS = {
  en: {
    ...
    sub: 'Booking boards in at the counter. About 2 minutes.',
    ...
    bin: 'One board per bin. Look for the “free” tick.',
  ...
  ta: {
    ...
    bin: 'ஒரு பின்ல ஒரு போர்டு மட்டும். “free” டிக் வருதான்னு பாருங்க.',
