...
export const CAPTIONS = {
  en: {
    ...
    allot: 'Clear what to do? Tick it here and allot it.<small>No quotation needed. Module 05.</small>',
  ...
  ta: {
    ...
    note: 'அவங்ககிட்ட என்ன கேட்டீங்கன்னு எழுதுங்க. இது கட்டாயம்.<small>எழுதற வரைக்கும் பட்டன் வேலை செய்யாது.</small>',
    waiting: 'இப்போ “Waiting on the customer”.<small>“Awaiting Customer Input”: அலாட் பண்ண முடியாது.</small>',
    nothingSent: 'சிஸ்டம் கஸ்டமருக்கு எதுவும் அனுப்பாது.<small>நீங்களே ஃபோன் அல்லது ஈமெயில் பண்ணணும்.</small>',
    back: 'பதில் வந்துச்சா? “Input received”, என்ன வந்துச்சுன்னு எழுதுங்க.<small>ஜாப் திரும்ப “Under Assessment”க்கு வரும்.</small>',
    decide: 'இப்போ அசெஸ்மென்ட் தான் அடுத்த ஸ்டெப்பை முடிவு பண்ணும்.',
    allot: 'என்ன பண்ணணும்னு க்ளியரா இருக்கா? இங்கே டிக் பண்ணி அலாட் பண்ணுங்க.<small>கொட்டேஷன் தேவையில்ல. மாட்யூல் 05.</small>',
    ...
    segment: 'எந்த கஸ்டமரா இருந்தாலும், எந்த பில்லிங் செக்மென்ட்டா இருந்தாலும்.<small>செக்மென்ட் இல்ல, அசெஸ்மென்ட் தான் முடிவு பண்ணும்.</small>',
